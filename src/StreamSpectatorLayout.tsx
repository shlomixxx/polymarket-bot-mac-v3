    ...
    >
      ...
      >
        <div>
          ...
          >
            English overlay — run P&amp;L, one session clock, round history. Use <code style={{ color: "var(--accent-bright)" }}>?stream=3</code> or{" "}
            <code style={{ color: "var(--accent-bright)" }}>/stream/spectator</code>.
          </p>
        </div>
      ...
      <BroadcastFit enabled={fitBroadcast} parentRef={broadcastParentRef} contentRef={broadcastContentRef}>
        ...
        <footer style={{ marginTop: 24, fontSize: 12, color: "var(--muted)" }}>
          <strong style={{ color: "var(--text-secondary)" }}>Classic</strong> (<code style={{ color: "var(--accent-bright)" }}>?stream=1</code>) and{" "}
          <strong style={{ color: "var(--text-secondary)" }}>Showcase</strong> (<code style={{ color: "var(--accent-bright)" }}>?stream=2</code>) are unchanged. This page:{" "}
          <code style={{ color: "var(--accent-bright)" }}>?stream=3</code> · <code style={{ color: "var(--accent-bright)" }}>#stream-stats</code>
          . Classic &amp; Showcase: optional <code style={{ color: "var(--accent-bright)" }}>&amp;usd=0</code> hides $ readouts there.
        </footer>
      </BroadcastFit>
    </div>
  );
